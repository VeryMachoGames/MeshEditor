...
namespace MeshEditor.Editor.Helper
{
    public class Handler
    {
        ...
        public static Vector3 DragHandle(Vector3 position, float handleSize,
            ...
            switch (Event.current.GetTypeForControl(id))
            {
                ...
                case EventType.MouseDrag:
                    if (GUIUtility.hotControl == id)
                    {
                        ...
                        Vector3 position2 =
                            Camera.current.WorldToScreenPoint(Handles.matrix.MultiplyPoint(s_DragHandleWorldStart))
